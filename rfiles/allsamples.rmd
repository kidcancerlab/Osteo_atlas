...
sobject <- qs::qread("output/seurat_objects/tumor_vs_stroma/patient_prim_tumor.qs")
...
Run_GRA <- function(sobject,
    ...
    #data(list = str_c("motifAnnotation_", org), package="RcisTarget")
...
scenicOptions <- Run_GRA(sobject = sobject,
