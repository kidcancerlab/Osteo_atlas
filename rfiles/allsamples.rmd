...
sobj <- qs::qread("output/seurat_objects/annotated_sobjs/patient_mets.qs")

DimPlot(sobj, group.by = c("new", "seurat_clusters", "sample_name"))
...
sobj <- qs::qread("output/seurat_objects/harmony_sobjs/patient_mets.qs")
DimPlot(sobj, group.by = c("new", "seurat_clusters"))
...
annotated <- qs::qread("output/seurat_objects/annotated_sobjs/patient_mets.qs")
x <- DimPlot(annotated,
             group.by = c("sample_name", "new", "data_type"),
             repel = T,
             label = T)

tumor <- qs::qread("output/seurat_objects/tumor_vs_stroma/patient_mets_tumor.qs")
y <- DimPlot(tumor,
             group.by = c("seurat_clusters", "new", "data_type"),
             repel = T,
             label = T)

stroma <- qs::qread("output/seurat_objects/tumor_vs_stroma/patient_mets_normal.qs")
z <- DimPlot(stroma,
             group.by = c("seurat_clusters", "new", "data_type"),
             repel = T,
             label = T)
