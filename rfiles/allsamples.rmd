...
cat_tib <- tribble(
    ...
    #"C5",        "BP",    "GOBP",
    #"C5",        "CC",    "GOCC",
    "H",         NULL,     "Hallmark_paths",
    "C3",      "TFT:GTRD", "Transcription_factor_targets",
    "C6",       NULL,      "Oncogenic_signature")
...
two_way_dotplot(top5up_down, x= "NES")
...
DimPlot(seuratobject, group.by = "seurat_annotations")
exprMat <- GetAssayData(seuratobject, assay='RNA', slot='counts')
exprMat <- as.matrix(exprMat)

# cell information
Idents(seuratobject) <- seuratobject$seurat_annotations
...
colVars <- list(CellType = c("Naive CD4 T" = "forestgreen",
                             "Memory CD4 T" = "darkorange",
                             "CD14+ Mono" = "magenta4",
                             "NK" = "red3",
                             "B" = "skyblue", 
                             "CD8 T" = "hotpink"))
...
interestingGenes <- c("ISG15", "PTEN", "IL16")
# any missing?
...
AUCell::AUCell_plotTSNE(tSNE_scenic$Y, exprMat, 
  aucell_regulonAUC[onlyNonDuplicatedExtended(
    rownames(aucell_regulonAUC))[c("BCLAF1", "MAX", "PHF20", "RFX5", "NFIC")],], 
  plots="Expression")
