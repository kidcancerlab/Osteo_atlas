...
tumor_list <- c("patient_prim_tumor",
                "patient_mets_tumor",
                "mm_prim_tumor",
                "mm_mets_tumor",
                "xeno_prim_human",
...
gsea <- parallel::mclapply((tumor_list), function(sobj_name) {
...
## Stromal analysis
```{r}
human_lung <- qs::qread("input/downloads/human_lung.qs")
human_bone <- qs::qread("output/seurat_objects/annotated_sobjs/normal_bone.qs")
mouse_lung <- qs::qread("input/downloads/mouse_lung.qs")
