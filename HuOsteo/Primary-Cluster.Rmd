...
prim_harmony_comb <- qs::qread("Seurat_objects/Primary/prim_harmony_comb.qs")
# Plot the integrated samples
DimPlot(prim_harmony_comb)

DimPlot(prim_harmony_comb, group.by = "src")

DimPlot(prim_harmony_comb, split.by = "src", ncol = 4)
```
...
```{r}
comb <- kill_cc(prim_harmony_comb)
```
...
FeaturePlot(comb, features = "os_score1",
