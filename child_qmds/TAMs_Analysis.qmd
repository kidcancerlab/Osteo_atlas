...
for (group in c("patient_prim_normal_cells", "patient_mets_normal_cells",
    ...
    # make a new col for the plot labels
    harm_mac_obj$plot_labels <-
        harm_mac_obj$Ann_Level3 %>%
        as.character() %>%
        gsub("_", " ", .)
...
dotplot_panel <- 
    ...
    patchwork::plot_annotation(title = "TAMs Cell Type Markers")
