...
for snob in sn_obs:
    python_functions.write_obs(ob = snob, method = "sn", mode = "stochastic")
    python_functions.save_plots(ob = snob, method = "sn", mode = "stochastic")


for scob in sc_obs:
    write_obs(ob = scob, method = "sc", mode = "stochastic")
    save_plots(ob = scob, method = "sc", mode = "stochastic")
