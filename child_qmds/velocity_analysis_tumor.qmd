...
#remove T_OS_0046_M1 bc it has a bad bam file
os.remove("loom_output/metadata/dogs_mets_cancer_cells/T_OS_0046_M1_metadata.csv")
os.remove("loom_output/metadata/dogs_mets_normal_cells/T_OS_0046_M1_metadata.csv")
os.remove("loom_output/metadata/dogs_mets/T_OS_0046_M1_metadata.csv")
...
sc_obs = list(filter(lambda x:"dogs_mets" not in x, sc_obs))
