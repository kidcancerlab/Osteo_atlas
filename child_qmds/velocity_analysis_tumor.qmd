...
for snob in sn_obs:
    python_functions.write_obs(ob = snob, method = "sn")
    python_functions.save_plots(ob = snob, method = "sn")
...
sc_obs = os.listdir("loom_output/split_metadata/sc/")
for scob in sc_obs:
    if not os.path.exists("loom_output/split_ad/stochastic/sc/" + scob + ".ad"):
        write_obs(
            ob = scob,
            method = "sc",
            mode = "stochastic",
            out_prefix = "loom_output/split_ad/stochastic/"
        )
    # ad_ob = calc_velo(scob, mode = "stochastic")
    save_plots(ob = scob, method = "sc", file_prefix = "output/figures/rna_velocity/stochastic/", ad_prefix = "loom_output/split_ad/stochastic/sc/")
...
ad_ob = loom_to_an(
    ...
    metadata_dir = "loom_output/split_metadata/sc"
)
