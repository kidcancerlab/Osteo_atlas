...
sc_obs = os.listdir("loom_output/split_metadata/sc/")
for scob in sc_obs:
    write_obs(ob = scob, method = "sc", mode = "stochastic", out_prefix = "loom_output/split_ad/stochastic/")
    # ad_ob = calc_velo(scob, mode = "stochastic")
    save_plots(ob = scob, method = "sc", file_prefix = "output/figures/rna_velocity/stochastic/")
