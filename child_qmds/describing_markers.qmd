...
for (group in c("patient_prim_normal_cells", "patient_mets_normal_cells",
    ...
    # save the plot
    if (!dir.exists("output/figures/Final_Annotations/results2/supplementary/")) {
        dir.create("output/figures/Final_Annotations/results2/supplementary/", recursive = TRUE)
    }

    ggsave(str_c("output/figures/Final_Annotations/results2/supplementary/",
...
# the made cols are here
cols <- list(
    `Endothelial Artery` = "#D43F3AFF",
    `Endothelial Capillary` = "#EEA236FF",
    `Endothelial Vein` = "#357EBDFF",
    `Endothelial Lymphatic` = "#5CB85CFF",
    AT2 = "#B8B8B8FF",
    AT1 = "#9632B8FF",
    `Ciliated cells` = "#46B8DAFF",
    `Tuft cells` = "#90302DFF"
)
...
for (group in c("patient_prim_normal_cells", "patient_mets_normal_cells",
    ...
    # Filter for features present in the group
    order_cell_subset <-
        intersect(celltypes, unique(object$plot_labels))
