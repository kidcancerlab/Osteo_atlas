...
title_replacement <- 
    list(patient_prim_normal_cells = "Patient Primary Stroma",
        ...
        dogs_prim_normal_cells = "Canine Primary Stroma",
        dogs_mets_normal_cells = "Canine Metastatic Stroma")
...
title_replacement <- 
    list(patient_prim_cancer_cells = "Patient Primary Tumor",
        ...
        dogs_prim_cancer_cells = "Canine Primary Tumor",
        dogs_mets_cancer_cells = "Canine Metastatic Tumor")
