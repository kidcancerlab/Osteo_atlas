...
for (group in c("patient_prim_normal_cells", "patient_mets_normal_cells",
    ...
    qs::qsave(dimplot,
            str_c("output/figures/Final_Annotations/ryan_needs/stromal_plots/",
                group,
                "_dimplot.qs"))
...
for (group in c("patient_prim_cancer_cells", "patient_mets_cancer_cells",
    ...
    qs::qsave(cancer_plot,
            str_c("output/figures/Final_Annotations/ryan_needs/tumor_plots/",
                group,
                "_dimplot.qs"))
...
qs::qsave(harmony_sobj,
        str_c("output/seurat_objects/final_combined_sobjs/",
                "harmony_human_xeno_cancer_cells",
                ".qs"))
