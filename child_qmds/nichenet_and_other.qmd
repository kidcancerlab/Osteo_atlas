...
# for ryan
prim_modules <- list(
    ECM_Remodelling   = c("COLLAGEN", "LAMININ", "FN1", "TGFb"),
    Cell_Adhesion     = c("CADM", "PTPRM", "NCAM"),
    Angiogenesis      = c("VEGF", "IGF", "ANGPT"),
    Immune_Modulation = c("CXCL"),
    Stemness          = c("BMP", "NRG"),
    Neuronal          = c("EPHA"),
    Metabolic         = c("Glutamate")
)
length(unlist(prim_modules))
# Metastatic
mets_modules <- list(
...
for (site in c("prim", "mets")) {
    ...
    heatmap_LR <- 
        ggplot(plot_cooraltion_df_df, 
            ...
            # aes(x = Var2, y = factor(Var1, levels = c("Glutamate", "EPHA", "NRG", "BMP", "CXCL", "IGF", "VEGF", "NCAM", "PTPRM", "CADM", "TGFb", "FN1", "LAMININ", "COLLAGEN")), fill = Freq)) +
    ...
    qs::qsave(heatmap_LR,
            file = str_c("output/figures/cellchat/sharedgenes_modules/correlation_heatmap_pathways_",
                site, ".qs"))
}  
