...
ggsave("output/figures/epithelial_analysis/enrichment_of_epithelial_clusters_in_tumor_vs_normal.pdf",
    enrichment_cluster,
    width = 5,
    height = 5,
    bg = "white"
...
ggsave("output/figures/epithelial_analysis/dimplot_epithelial_clusters.pdf",
    dimplot1,
    width = 5,
    height = 5,
    bg = "white"
...
ggsave("output/figures/epithelial_analysis/dimplot_epithelial_tumor_vs_normal.pdf",
    dimplot2,
    width = 5,
    height = 5,
    bg = "white"
...
ggsave("output/figures/epithelial_analysis/dimplot_epithelial_annotation_detailed.pdf",
    dimplot3,
    width = 5,
    height = 5,
    bg = "white"
...
enrichment_mesenchymal <-
    table(Epithelial_cells_all$Annotation_detailed, Epithelial_cells_all$unique) %>%
        as.data.frame() %>%
        group_by(Var2) %>%
        mutate(Proportion = Freq / sum(Freq)) %>%
        ungroup() %>%
...
ggsave("output/figures/epithelial_analysis/enrichment_of_mesenchymal_in_tumor_vs_normal_barplot.pdf",
    enrichment_mesenchymal,
    width = 5,
    height = 5,
    bg = "white"
...
ggsave("output/figures/epithelial_analysis/gsea_mesenchymal_vs_AT1AT2.pdf",
    gsea_plot,
    width = 5,
    height = 4,
    bg = "white"
