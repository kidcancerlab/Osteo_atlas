...
SpatialDimPlot(spatial_list$OS4_Seurat,
                alpha = 0) + NoLegend()
...
DimPlot(spatial_obj, reduction = "umap", label = TRUE) + ggtitle("UMAP - Visium Clusters")
FeaturePlot(spatial_obj, features = c("TAMs"), order=T, pt.size = 1)


SpatialDimPlot(spatial_list$OS7_Seurat, group.by = "SCT_snn_res.0.4", label = TRUE, label.size = 3)
...
# retain spatial plot separately
SpatialDimPlot(spatial_list$OS1_Seurat, group.by = "SCT_snn_res.0.4", label = TRUE, label.size = 3)
