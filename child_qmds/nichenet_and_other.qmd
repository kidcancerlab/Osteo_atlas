...
# cellchat at ann_level2 using all the pathways general
list_of_genes <- list()
...
> sig_pathways_list
$Pericytes_in_patient_prim_vs_patient_mets
# A tibble: 7 × 2
  pathway_name fold_change
  <chr>              <dbl>
1 CD99              0.240 
2 MK                0.156 
3 ADGRL             0.220 
...
$T_cells_in_patient_prim_vs_patient_mets
# A tibble: 3 × 2
  pathway_name fold_change
  <chr>              <dbl>
1 MIF                0.202
...
$TAMs_in_patient_prim_vs_patient_mets
# A tibble: 2 × 2
  pathway_name fold_change
  <chr>              <dbl>
1 MIF                0.238
...
$DC_in_patient_prim_vs_patient_mets
# A tibble: 1 × 2
  pathway_name fold_change
  <chr>              <dbl>
1 MIF                0.234

$Monocytes_in_patient_prim_vs_patient_mets
# A tibble: 2 × 2
  pathway_name fold_change
  <chr>              <dbl>
1 MIF                0.290
...
$Endothelial_cells_in_patient_prim_vs_patient_mets
# A tibble: 4 × 2
  pathway_name fold_change
  <chr>              <dbl>
1 LAMININ            0.291
...
$Endothelial_cells_in_mm_primhuman_ortho_vs_mm_metshuman_ortho
# A tibble: 1 × 2
  pathway_name fold_change
  <chr>              <dbl>
1 SPP1               0.270
...
$Pericytes_in_dogs_primhuman_ortho_vs_dogs_metshuman_ortho
# A tibble: 3 × 2
  pathway_name fold_change
  <chr>              <dbl>
1 FN1                0.242
