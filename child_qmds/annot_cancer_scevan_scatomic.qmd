...
samples <- c(
    ...
    # "X00018_human",
    # "X00020_human",
    "X00021_human",  # xeno primary tumor cell with femur head
    "X00019_human"   # xeno primary tumor cell with femur head
)
...
patchwork::wrap_plots(
    ...
    dimplot_better(combine_sobject, group_by = "copykat_tumor_cal"),
    dimplot_better(combine_sobject, group_by = "annot_with_tumor_as_whole"),
...
for (group in samples_for_validation) {
    ...
    combine_sobject$scevan_tumor_call <-
        ifelse(combine_sobject$scevan_tumor_call == "cancer_cells",
                "Tumor",
                "Normal")
    combine_sobject$copykat_tumor_cal <-
