...
def loom_to_an(obj_name):
    #Get sample id's from metadata files
    md_files=os.listdir("new_looms/metadata/" + obj_name)
    ...
    for one_md in md_files:
        ...
        #add object to list
        tmp = anndata.read_loom("new_looms/" + sample_id + "/" + sample_id + ".loom")
        #read in metadata file
        md_path = "new_looms/metadata/" + obj_name + "/" + one_md
