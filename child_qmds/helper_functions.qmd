...
def calc_velo(ad_ob, mode = "dynamical", group = "seurat_clusters"):
    sc.v.pp.filter_and_normalize(ad_ob, n_top_genes = 2000)
...
def make_plots(ad_ob):
    ...
    scv.pl.velocity_embedding_stream(ad_ob, basis = "umap", color = "Ann_Level3")
    scv.pl.velocity_embedding_stream(ad_ob, basis = "umap", color = "Ann_Level2")
    scv.pl.velocity_embedding_stream(ad_ob, basis = "umap", color = "Ann_Level1")
