...
for (group in unique(combine_all$Ann_Level3)) {
...
for (group in unique(combine_all$Ann_Level3)) {
    ...
    box_plot <-
        ...
        labs(
            title = str_c("Significant Features in ", group, " Primary vs Metastasis"),
            x = "Regulon",
    ...
    ggsave(str_c("plots/heatmap.png"),
        plot = heatmap,
        width = 4,
        height = 8)
    ...
    ggsave(str_c("plots/tile_plot.png"),
        plot = tile_plot,
        width = 4,
        height = 8)
    ...
    ggsave(str_c("plots/volcano_plot.png"),
        plot = volcano_plot,
        width = 6,
        height = 6,
        bg = "white")
