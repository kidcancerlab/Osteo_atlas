...
#| cache.vars: [preharmony_dimplot_list, featureplot1_tumor_list, featureplot2_immune_list]
...
#| cache.vars: [postharmony_dimplot_list, posth_featureplot1_tumor_list, posth_eatureplot2_immune_list, force_directed_layout_list]
...
#| cache.vars: [all_dimplots_list, alltumor_featureplot_list, allimmune_featureplot_list, force_directed_plots]
...
#| cache.vars: [stroma_celltype_aucell_plots, levels_of_annotations]
all_groups <-
...
#| cache.vars: [Regulon_heatmap_list, binarized_heatmap_list]
all_groups <-
    c("patient_prim_cancer_cells",
      "patient_mets_cancer_cells",
      "mm_prim_cancer_cells",
