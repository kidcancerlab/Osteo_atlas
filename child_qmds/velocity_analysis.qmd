...
First we need to read in our objects for this. The most up to date object seems to change frequently, but as of 2/25 at 4:30 pm i'm using the ojbects in final_tumor_vs_stroma.
