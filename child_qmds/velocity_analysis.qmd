...
dog_samps[dog_samps$sample_id == "S0032", ] <-
...
for ob in ob_names:
    ...
    #create plots
    scv.pl.velocity_embedding_stream(merged_ad, basis = "umap", color = "seurat_clusters", show = False, save = ob + "_umap_clusters.png", dpi = 300)
    #optionally create fdl plot
    if len(merged_ad.obsm["X_fdl"]) == 2:
        scv.pl.velocity_embedding_stream(merged_ad, basis = "fdl", color = "seurat_clusters", show = False, save = ob + "_fdl_clusters.png", dpi = 300)
