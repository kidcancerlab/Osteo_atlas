...
for ob in ob_names:
    ...
    scv.pl.velocity_embedding_stream(ad_ob,
                                     ...
                                     palette = hex_codes,
                                     sort_order = False)
    pyplot.savefig("figures/scvelo/yogesh_4_15_25/" + ob + "_umap_clusters.svg")
    #seurat_clusters in fdl
    scv.pl.velocity_embedding_stream(ad_ob,
                                     basis = "fdl",
                                     color = "seurat_clusters",
                                     ...
                                     show = False,
                                     sort_order = False)
    pyplot.savefig("figures/scvelo/yogesh_4_15_25/" + ob + "_fdl_clusters.svg")
    ...
    if ob.find("cancer") != -1 or ob.find("_human") != -1:
        ...
        scv.pl.velocity_embedding_stream(ad_ob,
                                         ...
                                         show = False,
                                         sort_order = False)
        pyplot.savefig("figures/scvelo/yogesh_4_15_25/" + ob + "_umap_annotations.svg")
        #cell types in fdl
        scv.pl.velocity_embedding_stream(ad_ob,
                                         basis = "fdl",
                                         color = "Ann_Level3",
                                         ...
                                         show = False,
                                         sort_order = False)
        pyplot.savefig("figures/scvelo/yogesh_4_15_25/" + ob + "_fdl_annotations.svg")
    else:
        #Ann_Level3 in umap space
        scv.pl.velocity_embedding_stream(ad_ob,
                                         basis = "umap",
