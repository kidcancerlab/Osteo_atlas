...
def write_ob_and_plots(ob):
    ...
    scv.pl.velocity_embedding_stream(merged_ad,
                                     ...
                                     show = False,
                                     sort_order = False)
    pyplot.savefig("figures/scvelo/" + ob + "_umap_clusters.svg")
    ...
    scv.pl.velocity_embedding_stream(merged_ad,
                                     ...
                                     show = False,
                                     sort_order = False)
    pyplot.savefig("figures/scvelo/" + ob + "_umap_annotations.svg")
    ...
    scv.pl.velocity_embedding_stream(merged_ad,
                                     ...
                                     show = False,
                                     sort_order = False)
    pyplot.savefig("figures/scvelo/" + ob + "_fdl_clusters.svg")
    #cell types in fdl
    scv.pl.velocity_embedding_stream(merged_ad,
                                     basis = "fdl",
                                     color = "Ann_Level3",
                                     show = False,
                                     sort_order = False)
    pyplot.savefig("figures/scvelo/" + ob + "_fdl_annotations.svg")
    return(ob + " is done")
...
all_cmap = ListedColormap(hex_codes)
...
for ob in ob_names:
    ...
    scv.pl.velocity_embedding_stream(ad_ob,
                                     ...
                                     color_map = all_cmap,
                                     sort_order = False)
    pyplot.savefig("figures/scvelo/yogesh_4_10_25/" + ob + "_umap_clusters.svg")
    #seurat_clusters in fdl
    scv.pl.velocity_embedding_stream(ad_ob,
                                     basis = "fdl",
                                     color = "seurat_clusters",
                                     ...
                                     show = False,
                                     sort_order = False)
    pyplot.savefig("figures/scvelo/yogesh_4_10_25/" + ob + "_fdl_clusters.svg")
    ...
    if ob.find("cancer") != -1 or ob.find("_human") != -1:
        ...
        scv.pl.velocity_embedding_stream(ad_ob,
                                         ...
                                         show = False,
                                         sort_order = False)
        pyplot.savefig("figures/scvelo/yogesh_4_10_25/" + ob + "_umap_annotations.svg")
        #cell types in fdl
        scv.pl.velocity_embedding_stream(ad_ob,
                                         basis = "fdl",
                                         color = "Ann_Level3",
                                         ...
                                         show = False,
                                         sort_order = False)
        pyplot.savefig("figures/scvelo/yogesh_4_10_25/" + ob + "_fdl_annotations.svg")
    else:
        #Ann_Level3 in umap space
        scv.pl.velocity_embedding_stream(ad_ob,
                                         basis = "umap",
