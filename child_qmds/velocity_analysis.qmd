...
def write_ob_and_plots(ob):
    ...
    scv.pl.velocity_embedding_stream(merged_ad,
                                     ...
                                     show = False)
    pyplot.savefig("figures/scvelo/" + ob + "_umap_clusters.png")
    #Ann_Level3 in umap space
    scv.pl.velocity_embedding_stream(merged_ad,
                                     basis = "umap",
                                     color = "Ann_Level3",
                                     show = False)
    pyplot.savefig("figures/scvelo/" + ob + "_umap_annotations.png")
    #seurat_clusters in fdl
    scv.pl.velocity_embedding_stream(merged_ad,
                                     basis = "fdl",
                                     color = "seurat_clusters",
                                     show = False)
    pyplot.savefig("figures/scvelo/" + ob + "_fdl_clusters.png")
    #cell types in fdl
    scv.pl.velocity_embedding_stream(merged_ad,
                                     basis = "fdl",
                                     color = "Ann_Level3",
                                     show = False)
    pyplot.savefig("figures/scvelo/" + ob + "_fdl_annotations.png")
    return(ob + " is done")
