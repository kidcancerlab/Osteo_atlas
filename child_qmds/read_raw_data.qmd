...
dog_mart <- 
    biomaRt::useDataset("clfamiliaris_gene_ensembl",
                        mart = ensembl)
human_mart <- 
    biomaRt::useDataset("hsapiens_gene_ensembl",
                        mart = ensembl)

# Retrieve dog-to-human orthologs
dog_to_human <- 
    biomaRt::getBM(attributes = c("ensembl_gene_id",                 # Dog gene ID
...
for (item in single_sobjs){
    sobj <- 
        qs::qread(str_c("output/seurat_objects/sobj_preprocess/",
                        item))
