...
for (group in c("patient_prim", "patient_mets",
    ...
    for (cell_group_name in c("cancer_cells", "normal_cells")) {
        ...
        if  (cell_group_name == "normal_cells") {
            ...
            s_obj$cell_scores <- ref_lung$scores
...
object1 <- 
    qs::qread("output/seurat_objects/tumor_vs_stroma/mm_prim_normal_cells.qs")
object2 <-
    qs::qread("output/seurat_objects/tumor_vs_stroma/mm_mets_normal_cells.qs")
