...
myeloid_tumor <- parallel::mclapply(names(spatial_list), function(ob_name) {
    sp_ob <- spatial_list[[ob_name]]
    coords <- GetTissueCoordinates(sp_ob, image = "slice1") %>%
        dplyr::rename(x = imagerow, y = imagecol)
    #convert our object to an rctd object
...
"#D43F3AFF" "#EEA236FF" "#357EBDFF" "#5CB85CFF" "#B8B8B8FF" "#9632B8FF"
"#46B8DAFF" "#90302DFF" "#A66D04FF" "#2D577FFF" "#3E7E3EFF" "#7D7D7DFF"
"#6D1D87FF" "#097F9AFF" "#FF6E6AFF" "#FFBB70FF" "#68A4E3FF" "#79D379FF"
