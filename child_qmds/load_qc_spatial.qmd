...
Right now I'm interested in the fibrogenic TAMs population and the Interactive tumor subpopulation.
...
spatial_list <- lapply(
    spatial_list,
    AddModuleScore,
    features = myeloid_modules[["Fibrogenic_TAMs"]],
    name = "Fibrogenic_TAMs"
)
