...
patient_mets[["cancer"]] <-
    qs::qread(paste0(yogi_path,
                    "output/seurat_objects/tumor_vs_stroma/patient_mets_cancer_cells.qs"))
patient_mets[["stromal"]] <- qs::qread(paste0(yogi_path,
                                              "output/seurat_objects/tumor_vs_stroma/patient_mets_normal_cells.qs"))

patient_mets <- merge(patient_mets[["cancer"]], patient_mets[["stroma"]])
