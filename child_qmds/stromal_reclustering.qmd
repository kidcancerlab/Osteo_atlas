...
celltype_list <-
    list(patient_prim_normal_cells = list(Mesenchymal = c("^0$" = "mCAFs",
                                                        "^1$" = "myCAFs",
                                                        "^2$" = "mCAFs",
                                                        "^3$" = "apCAFs",
                                                        "^4$" = "apCAFs",
        ...
        patient_mets_normal_cells = list(Mesenchymal = c("^0$" = "Pericytes",
                                         ...
                                         Epithelial_Endothelial = c("^0$" = "AT1",
                                                                ...
                                                                "^22$" = "Tuft_cells",
                                                                "^23$" = "AT2")),
        xeno_prim_mouse = list(Mesenchymal = c("^0$" = "mCAFs",
                                                "^1$" = "mCAFs",
                                                "^2$" ="Pericytes",
                                                "^3$"= "Smooth_muscle"),
        ...
        dogs_prim_normal_cells = list(Mesenchymal = c("^0$" = "mCAFs",
                                ...
                                Epithelial_Endothelial = c("^0$" = "Endothelial_Vein",
                                                            ...
                                                            "^6$" = "Endothelial_Vein",
                                                            "^7$" = "Endothelial_Vein")),
        dogs_mets_normal_cells = list(Mesenchymal = c("^0$" = "myCAFs",
                                                    "^1$" ="apCAFs",
                                                    "^2$"= "Alv_CAFs",
                                                    "^3$" = "apCAFs",
                                                    "^4$" = "Adv_CAFs",
...
FeaturePlot(sobj_list$Immune_Myeloid,
            features = Interstitial_Mac,
            order = T)


FeaturePlot(sobj_list$Immune_Myeloid,
            features = c("TREM2", "SPP1", "FABP5", "GPNMB"),
            order = T)
FeaturePlot(sobj_list$Immune_Myeloid,
            features = c("CCL3", "CXCL2", "IL1B"),
            order = T)

dimplot_better(sobj_list$Immune_Myeloid, group_by = "Ann_Level3")
dimplot_better(sobj_list$Immune_Myeloid, group_by = "seurat_clusters")

cells <-
    sobj_list$Immune_Myeloid %>%
    subset(seurat_clusters == "25") %>%
    colnames()

obj <-
    qs::qread(str_c("output/seurat_objects/TAMs_objects/", group, ".qs"))

DimPlot(obj, cells.highlight = cells)
FeaturePlot(obj, features = c("TREM2", "SPP1", "FABP5", "GPNMB"), order = T)
FeaturePlot(obj, features = c("CCL3", "CXCL2", "IL1B"), order = T)
dimplot_better(obj, group_by = "Ann_Level3")
...
#dimplot_better(stroma_obj,group_by = "Ann_Level2", raster =F) +NoLegend()
```
...
for (group in c("patient_prim", "patient_mets", "mm_prim", "mm_mets",
    ...
    combined_plot2 <-
        dimplot_better(object, group_by = "Ann_Level2", raster = F) + 
        NoLegend()

    combined_plot3 <-
        dimplot_better(object, group_by = "Ann_Level1", raster = F) +
        NoLegend()

    combined_plot4 <-
        dimplot_better(object, group_by = "Ann_Level0", raster = F) +
        NoLegend()
