...
Immune_Myeloid <- 
    list(
        ...
        Inflam_TAMs = c("IL1B", "CCL3", "CXCL1", "CXCL2", "CXCL3", "CXCL5", "CXCL8"),
        ...
        Scar_Macs = c("CD9", "SPP1", "TREM2", "GPNMB", "FABP5"),
        TAMs = c("MERTK", "FOLR2", "SELENOP"),
        IFN_TAMs = c("CXCL10", "IFIT2"),
        Inflammatory_TIMs = c("CD14", "CD68", "CCR2", "TLR4", "IL1B", 
                                "TNF", "NOS2", "S100A8", "S100A9", "CXCL8",
                                "C5AR1", "CD86", "HLA-DR", "CCL2", "MMP9"),
