...
patient_prim_mets_Immune_Myeloid <- 
    list(Osteoclast_TAMs = list("MMP9", "CTSK", "NFATC1", "ACP5"),
        #Reg_TAMs = list("STAB1", "COLEC12", "MAF", "MERTK"),
        #TAMs = list("SELENOP", "MS4A7", "MS4A6A", "MERTK", "STAB1"),
        Scar_TAMs = list("TREM2", "FABP5", "GPNMB", "MS4A4A"),
        Inflam_TAMs = list("CCL3", "CCL4", "CXCL1",  "CXCL8"),
        Prolif_TAMs = list("MKI67", "TOP2A", "CENPF", "NUSAP1"),
        IFN_TAMs = list("IFIT1", "IFIT2", "IFIT3", "IFI44L"),
        DC2 = list("FCER1A", "CLEC10A", "GPAT3", "FCGR2B"),
        ...
        Fibrogenic_TAMs = list("COL1A2", "COL3A1","COL5A1","SPARC"))

mouse_prim_mets_Immune_Myeloid <-
    list(IFN_TAMs = list("Ifit1", "Ifit2", "Ifi44", "Ifit3"),
        Neutrophils = list("S100a8", "S100a9", "Trem1", "Clec4d"),
        Prolif_TAMs = list("Mki67", "Top2a", "Cenpp", "Brip1"),
        Alv_TAMs = list("Plet1", "Lpl", "Abcg1", "Mgll"),
        Osteoclast_TAMs = list("Acp5", "Ctsk", "Nfatc1", "Mmp9"),
        Scar_TAMs = list("Trem2", "Spp1", "Gpnmb", "Fabp5"),
        Inflam_TAMs = list("Cxcl1", "Fn1", "Ccl24", "Cxcl3"),
        # Erythroblast = list("Hba-a1", "Hba-a2", "Hbb-bt", "Hbb-bs"),
        Ciliated_cells = list("Foxj1", "Dnah9", "Hydin", "Rp1"),
        # ncMonocytes = list("Nr4a1", "Pparg", "Spn", "Treml4"),
        # cMonocytes = list("Ccr2", "Vcan", "Thbs1", "Cd14"),
        pDC = list("Tcf4", "Pacsin1",  "Aff3", "Satb1"),
        Migratory_DC = list("Ccr7", "Fscn1", "Ccl5", "Cd40"),
        DC2 = list("Mgl2", "H2-DMb2", "Clec10a", "H2-Oa"),
        DC1 = list("Itgae", "Cd207", "Wdfy4", "Btla"),
        Fibrogenic_TAMs = c("Col1a2", "Col3a1", "Sparc", "Col5a1"),
        Monocytes = list("Itgal", "Adgre4", "Treml4", "Spn"))

xeno_prim_mets_Immune_Myeloid <-
    list(IFN_TAMs = list("Ifit1", "Ifit2", "Ifi44", "Ifit3"),
        Neutrophils = list("S100a8", "S100a9", "Trem1", "Clec4d"),
        Prolif_TAMs = list("Mki67", "Top2a", "Cenpp", "Brip1"),
        Alv_TAMs = list("Plet1", "Lpl", "Abcg1", "Mgll"),
        Osteoclast_TAMs = list("Acp5", "Ctsk", "Nfatc1", "Mmp9"),
        Scar_TAMs = list("Trem2", "Cd36", "Gpnmb", "Fabp5"),
        Inflam_TAMs = list("Cxcl1", "Fn1", "Ccl7", "Ccl2"),
        # Erythroblast = list("Hba-a1", "Hba-a2", "Hbb-bt", "Hbb-bs"),
        Ciliated_cells = list("Foxj1", "Dnah9", "Hydin", "Rp1"),
        # ncMonocytes = list("Nr4a1", "Pparg", "Spn", "Treml4"),
        # cMonocytes = list("Ccr2", "Vcan", "Thbs1", "Cd14"),
        pDC = list("Ccr9", "Spib", "Bcl11a", "Sell", "Tcf4"),
        Migratory_DC = list("Ccr7", "Fscn1", "Ccl5", "Cd40"),
        Fibrogenic_TAMs = c("Col1a2", "Col3a1", "Sparc", "Col5a1"),
        Monocytes = list("Ly6c2", "Ly6c1", "Ccr2", "Plac8"),
        DC = list("Flt3", "Zbtb46", "Cbfa2t3", "H2-Ab1"))

dog_prim_mets_Immune_Myeloid <- 
    list(Osteoclast_TAMs = list("MMP9", "NFATC1", "ACP5", "ATP6V0D2"),
        #Reg_TAMs = list("STAB1", "COLEC12", "MAF", "MERTK"),
        #TAMs = list("SELENOP", "MS4A7", "MS4A6A", "STAB1", "COLEC12", "CD68"),
        Scar_TAMs = list("TREM2", "GPNMB.1", "CD36", "MSR1"),
        Inflam_TAMs = list("CCL3", "IL1B", "IL37", "IL1A"),
        Prolif_TAMs = list("CCNA2", "UBE2C", "CENPF", "AURKB"),
        IFN_TAMs = list("IFIT1", "IFIT2", "IFIT3", "IFGGC1"),
        DC2 = list("FCER1A", "CD1B", "MS4A2", "SATB1"),
        #Monocytes = list("S100A8", "S100A9", "FCN1", "VCAN"),
        Migratory_DC = list("CCR7", "CD83", "CD40", "ENPP3"),
        DC1 = list("CLNK", "XCR1", "CD226", "TOX"),
        #Mast = list("TPSB2", "KIT", "HPGDS", "SLC24A3"),
        pDC = list("BCL11A", "TCF4", "FCRLA", "SPATS2L"),
        #Alv_TAMs = list("CHI3L1", "ALDH1A1", "ME1", "PPARG"),
        Fibrogenic_TAMs = list("MMP16", "CDH11", "COL1A1", "COL1A2"),
        Neutrophils = list("S100A9", "CSF3R", "SELL", "SRGN"))
...
#dogs 
dogs_mesenchymal_marker_top6_list <- list(
  mCAFs = list("FBN1", "FN1", "COL14A1", "FBLN2"),
  #Smooth_muscle = list("MFAP5", "CCN3", "GPRC5A"),
  pCAFs = list("CENPA", "UBE2C", "CDC20", "CENPF"),
  apCAFs = list("CD74", "HLA-DRB1", "DLA-DQB1", "PTPRC"),
  Pericytes = list("RGS5", "MCAM", "KCNJ8", "GUCY1B1"),
  Progenitor = list("PRRX1", "LEPR", "IGF2", "CCN2"),
  Adv_CAFs = list("CADM2", "DCN", "DPT", "SERPINF1"),
  Smooth_muscle = list("CNN1", "ACTN2", "MYOCD", "FLNC"))
dog_lymphoid_markers <- list(
    ...
    CD4_T = c("IL7R","LEF1",  "PLCL1", "TNIK"))
dog_marker_lists <- list(
    Ciliated_cells = list("FOXJ1", "DNAH9", "RSPH1", "LRRIQ1"),
    AT1 = list("AGER", "HOPX", "RTKN2", "CLIC5"),
    AT2 = list("SFTPC", "SFTPD", "CFTR", "SLC34A2"),
    Capillary_Aerocyte = list("HPGD", "EMP2", "CA4", "CNTNAP2"),
    Endothelial_Capillary = list("CD36", "JAM2", "SLC16A9", "GALNT15"),
    Endothelial_Artery = list("EFNB2", "HEY1", "GJA5", "SMAD6"),
    Endothelial_Prolif = list("GTSE1", "PCNA", "CENPF", "ASPM"),
    Endothelial_Lymphatic = list("PROX1", "CCL21", "MMRN1", "SEMA3D"),
    Endothelial_Vein = list("APOD", "ENTPD1", "PLCB1", "RAPGEF4"),
    Endothelial_Activated = list("LCP1", "VCAN", "CDH11", "COLEC12"))
dog_prim_mets_Immune_Myeloid <-
    list(Osteoclast_TAMs = list("MMP9", "NFATC1", "ACP5", "ATP6V0D2"),
        #Reg_TAMs = list("STAB1", "COLEC12", "MAF", "MERTK"),
        #TAMs = list("SELENOP", "MS4A7", "MS4A6A", "STAB1", "COLEC12", "CD68"),
...
celltype_top5_lymphoid <- list(
    ...
    Naive_T = list("LEF1", "BACH2", "TCF7", "TXK"))
celltype_top5_endo_epi <- list(
    AT2 = list("SFTPC", "SFTPB", "ABCA3", "SLC34A2"),
    Endothelial_Capillary = list("RGCC", "SPARC", "PLVAP", "ESM1"),
    ...
    Endothelial_Activated = list("TGFBI", "SLIT2", "SLIT3", "ZEB2"))
mesenchymal_marker_list <- list(
    Osteoblast = c("SPP1", "BGLAP", "IBSP", "OMD"), 
    Osteoblast_Stressed = c("SERPINE1", "PLIN2", "IER3", "PTX3"),
    adiCAFs = c("APOD", "IGF1", "SFRP2", "SFRP1"), 
    pCAFs = c("MKI67", "CCNB1", "CDC20", "CENPF"),
    apCAFs = c("CD74", "HLA-DRA", "C1QA", "HLA-DRB1"),
    Chondrocytes = c("COL2A1", "ACAN", "SOX9", "COL11A1"),
    Adv_Fibroblasts = c("CXCL14", "DCN", "MGP", "FBLN5"),
    Pericytes = c("RGS5", "TRPC6", "CDH6", "EDNRA"),
    Neuronal = c("SEMA3A", "TENM3", "PTPRD", "FAT3"),
    myCAFs = c("TAGLN", "MYL9", "TPM2", "SPARC")
)
...
# Mouse
mouse_mesenchymal <-
    list(Osteoblast=  c("Bglap", "Ibsp", "Bglap2", "Apoe"),
        mCAF = c ("Fn1", "Fbn1", "Dcn", "Fbln2"),
        Pericytes = c("Notch3", "Pdgfrb", "Mcam", "Cspg4"),
        Smooth_muscle = c("Acta2", "Tagln", "Myl9", "Myh11"),
        myCAFs =  c("Aspn", "Tgfbi", "Pdlim3", "Fhod3", "P4ha3"),
        apCAFs = c("Cd74", "H2-Aa", "H2-Ab1", "H2-Eb1", "H2-DMb1"),
        mCAFs = c("Col1a1", "Col1a2", "Col3a1", "Fbln2"),
        pCAFs = c("Mki67", "Top2a", "Aspm", "Nusap1", "Diaph3"),
...
endo_epi_mouse <- list(
    ...
    Endothelial_cells = c("Pecam1", "Cd34", "Cdh5", "Kdr")
)
mouse_lymphoid <-
    list(NK_cells = c("Gzma", "Prf1", "Serpinb9", "Gzmb"),
         CD8_T = c("Cd8a", "Cd8b1", "Trbc2", "Cd3d"),
         CD4_T = c("Il7r", "Icos", "Lat", "Cd4"),
         Naive_T = c("Tcf7", "Lef1", "S1pr1", "Bach2"),
         Naive_B = c("Ighd", "Pax5", "Ebf1", "Fcmr", "Lyn"),
         Plasma_B = c("Prdm1", "Xbp1", "Sdc1", "Jchain"),
         B_cells = c("Ebf1", "Lyn", "Xbp1", "Sdc1"),
...
xeno_endo_epi<-
    list(Endothelial_Vein = c("Nrp2", "Cdh13", "Nr2f2", "Vcam1"),
        Endothelial_Artery = c("Epas1", "Edn1", "Sox17", "Ptprb"),
        Endothelial_Capillary = c("Car4", "Prx", "Apln", "Rgs6"),
        Ciliated_cells = c("Tuba1a", "Dnah12", "Cfap54", "Ccdc181"),
        AT1 = c("Aqp5", "Ager", "Pdpn", "Hopx"),
        AT2 = c("Sftpb", "Sftpa1", "Sftpd", "Napsa"),
        Endothelial_Prolif = c("Mki67", "Top2a", "Cenpp", "Brip1"))
xeno_mesenchymal <-
    list(CAFs = c("Col1a1", "Col1a2", "Col3a1", "Fbln2"),
      Pericytes = c("Rgs5", "Pdgfrb", "Mcam", "Cspg4"),
      Muscle_cells = c("Myot", "Mypn", "Mlip", "Mylk4"),
      MSC =  c("Runx1", "Egfr", "Zfpm2", "Bicc1"),
      Alv_CAFs = c("Inmt", "Npnt", "Itga8", "Scube2"),
      Adv_CAFs = c("Pi16", "Dcn", "Lum", "Fbln1", "Igfbp6"),
      myCAFs= c(c("Tagln", "Tpm1", "Lgals1", "Mgp")))
...
sobj_list$Epithelial_Endothelial$ann_l3 <-
    str_replace_all(sobj_list$Epithelial_Endothelial$seurat_clusters,
                c("^0$" = "",
                "^1$" = "",
                "^2$" = "",
...
dimplot_better(sobj_list$Epithelial_Endothelial, group_by = "ann_l3") +
    NoLegend() 



dimplot_better(sobj_list$Epithelial_Endothelial, group_by = "data_source") +
    NoLegend() +
    ggtitle("Epithelial_Endothelial")


patchwork::wrap_plots(
    dimplot_better(sobj_list$Epithelial_Endothelial, group_by = "Ann_Level3") + NoLegend(),
    dimplot_better(sobj_list$Epithelial_Endothelial, group_by = "seurat_clusters") + NoLegend(),
    dimplot_better(sobj_list$Epithelial_Endothelial, group_by = "new_annot_clust") + NoLegend(),
    dimplot_better(sobj_list$Epithelial_Endothelial, group_by = "SingleR_Ann3") + NoLegend(),
    ncol = 2)

celltype_markers_mouse <- list(
    Endothelial_Activated = c("Tgfbi", "Zeb2", "Prkcb", "Nlrp3"),
    Endothelial_Capillary = c("Plvap", "Adgrl3", "Glp1r", "Sema3c"),
    Endothelial_Artery = c("Gja5", "Efnb2", "Cxcl12", "Dll4"),
    Endothelial_Vein = c("Vwf", "Ephb4", "Vcam1", "Ackr3"),
...
DotPlot(sobj_list$Epithelial_Endothelial,
            features = celltype_markers_mouse,
            group.by = "seurat_clusters",
            cols = "RdBu") +
        RotatedAxis() +
        theme(axis.text.x = element_text(angle = 90, hjust = 1))
...
patchwork::wrap_plots(
    DotPlot(sobj_list$Epithelial_Endothelial,
            features = Endothelial_Capillary,
            group.by = "ann_l3",
            cols = "RdBu") +
        RotatedAxis() +
        theme(axis.text.x = element_text(angle = 90, hjust = 1)),
    dimplot_better(sobj_list$Epithelial_Endothelial, group_by = "ann_l3") + NoLegend(),
    ncol = 1
)
# mets
sobj_list$Epithelial_Endothelial$ann_l3 <-
...
Idents(sobj_list$Epithelial_Endothelial) <- "ann_l3"
markers <- 
    FindAllMarkers(object = sobj_list$Epithelial_Endothelial,
                    logfc.threshold = 1,
                    min.pct = 0.1,
                    only.pos = T)
# reduce data
...
patchwork::wrap_plots(
    dimplot_better(sobj_list$Mesenchymal, group_by = "seurat_clusters") + NoLegend(),
    dimplot_better(sobj_list$Mesenchymal, group_by = "SingleR_Ann3") + NoLegend(),
    dimplot_better(sobj_list$Mesenchymal, group_by = "annotations") + NoLegend(),
    dimplot_better(sobj_list$Mesenchymal, group_by = "Ann_Level3") + NoLegend(),
    ncol = 2
)
...
DotPlot(object = sobj_list$Immune_Myeloid,
        features = celltype_top6_mesenchymal,
        group.by = "seurat_clusters",
        cols = "RdBu") +
    RotatedAxis() +
    theme(axis.text.x = element_text(angle = 90, hjust = 1))
...
dimplot_better(sobj1, group_by = "seurat_clusters") +
    NoLegend()

sobj_list$Immune_Myeloid$ann_l3 <-
    str_replace_all(sobj_list$Immune_Myeloid$seurat_clusters,
                   c("^0$" = "Reg_TAMs",
                        "^1$" = "Reg_TAMs",
                        "^2$" = "Reg_TAMs",
                        "^3$" = "Reg_TAMs",
...
dimplot_better(sobj_list$Immune_Myeloid, group_by = "ann_l3") +
    ggtitle("Mouse Myeloid Cells") + NoLegend()

DotPlot(object = sobj_list$Immune_Myeloid,
        features = celltype_top6_myeloid,
        group.by = "ann_l3",
        cols = "RdBu") +
    RotatedAxis() +
    theme(axis.text.x = element_text(angle = 90, hjust = 1))

FindMarkers(sobj_list$Immune_Myeloid,
            ident.1 = "Scar_TAMs",
            ident.2 = "Inflam_TAMs",
            group.by = "ann_l3",
            logfc.threshold = 0.25,
