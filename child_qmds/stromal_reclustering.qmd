...
FeaturePlot(xeno_merge, 
    features = nichenetr::convert_human_to_mouse_symbols(macrophage_features_cells$Inflam_TAMs))
...
c11 <-
    subset(sobj, seurat_clusters == 3) %>%
    colnames()
DimPlot(mouse_merge, cells.highlight = c11) +
    NoLegend()
DimPlot(mouse_merge, group.by = "annotations") +
    NoLegend()
...
dimplot_better(xeno_merge, group_by = "annotations") +
    NoLegend()

dimplot_better(xeno_merge, group_by = "Ann_Level3") +
    NoLegend()

DimPlot(stroma_obj, cells.highlight = c11) +
    NoLegend() 
DimPlot(object, cells.highlight = c11) +
    NoLegend() 

dimplot_better(stroma_obj, group_by = "Ann_Level3") +
    NoLegend()
    ...
    list(patient_prim_normal_cells = list(Mesenchymal = c("^0$" = "Osteoblasts",
        ...
        patient_mets_normal_cells = list(Mesenchymal = c("^0$" = "Pericytes",  # not sure about 2,5,6
                                         ...
                                         Immune_Myeloid = c("^0$" = "TAMs",
                                                            ...
                                                            "^11$" = "Mast",
                                                            "^12$" = "Proliferating_T",
                                                            "^13$" = "Monocytes", #cluster13 not sure
                                                            "^14$" = "Pericytes",
                                                            "^15$" = "IFN_TAMs",
                                                            "^16$" = "Alv_Macrophages",
                                                            "^17$" = "Prolif_TAMs",
...
c11 <-
    subset(sobj, seurat_clusters == 16) %>%
    colnames()
...
DimPlot(patient_merge, cells.highlight = c11) +
    NoLegend()
dimplot_better(patient_merge, group_by = "SingleR_Ann3", split_by = "tumor_type")
