...
## Dogs fixing manual annotation of each celltypes 
```{r manual_annotation_celltypes_dogs} 
#load the human mets immune myeloid cells annotated
patient_mets_myeloid <-
    qs::qread("output/seurat_objects/stromal_subtypes/patient_mets_normal_cells/Immune_Myeloid.qs")

#load the dogs mets myeloid cells 
dogs_mets_myeloid <- s_obj

#singleR ref
ref_lung <- 
    SingleR::SingleR(test = as.SingleCellExperiment(dogs_mets_myeloid),
                    ref = SeuratObject::GetAssayData(patient_mets_myeloid),
                    labels = patient_mets_myeloid$Ann_Level3,
                    aggr.ref = TRUE)

#annotate the dogs mets myeloid cells
dogs_mets_myeloid$Ann_Level3 <-
    ref_lung$labels

dimplot_better(dogs_mets_myeloid,
              group_by = "Ann_Level3") +
    ggtitle("Ann_Level3") +
    NoLegend()
...
celltype_list <-
    list(patient_prim_normal_cells = list(Immune_Lymphoid = c("^0$" = "CD8_T",
                                                            "^1$" = "CD4_T",
                                                            "^2$" = "Naive_T",
                                                            "^3$" = "NK_cells",
                                                            "^4$" = "Plasma_B",
        ...
        patient_mets_normal_cells = list(Mesenchymal = c("^0$" = "Pericytes",
                                                        "^1$" = "Alveolar_fibroblasts",
                                                        "^2$" = "EC_Blood",
                                                        "^3$" = "Pericytes",
                                                        "^4$" = "Alveolar_fibroblasts",
                                                        "^5$" = "EC_Blood",
                                                        "^6$" = "Smooth_muscle",
                                                        "^7$" = "Pericytes",
                                                        "^8$" = "Pericytes",
                                                        "^9$" = "Pericytes",
                                                        "^10$" = "Alveolar_fibroblasts",
                                                        "^11$" = "Pericytes",
                                                        "^12$" = "Alveolar_fibroblasts"),
                                         ...
                                         Epithelial_Endothelial = c("^0$" = "EC_Blood",
                                                                    ...
                                                                    "^11$" = "EC_Blood",
                                                                    "^12$" = "Tuft_cells")),
        xeno_prim_mouse = list(Mesenchymal = c("^0$" = "Fibroblasts",
                                                "^1$" = "Fibroblasts",
                                                "^2$" ="Stromal_cells",
                                                "^3$"= "Cardiomyocytes"),
                            ...
                            Epithelial_Endothelial = c("^0$" = "EC_Blood",
                                                        ...
                                                        "^3$" = "EC_Blood",
                                                        "^4$" = "EC_Blood")),
        xeno_mets_mouse = list(Mesenchymal = c("^0$" = "Myofibroblasts",
                                                "^1$" ="Alv_Fibroblasts",
                                                "^2$"= "Stromal_cells"),
                            Immune_Lymphoid = c("^0$" = "Naive_NKT",
                                                "^1$" = "Naive_NKT",
                            ...
                            Epithelial_Endothelial = c("^0$" = "EC_Blood",
                                                        ...
                                                        "^14$" = "EC_Blood",
                                                        "^15$" = "EC_Blood")),
        mm_prim_normal_cells = list(Mesenchymal = c("^0$" = "Fibroblasts"),
                                    Immune_Lymphoid = c("^0$" = "CD8_T",
                                                        "^1$" = "CD8_T",
                                                        "^2$" = "CD4_T",
                                                        "^3$" = "Regulatory_T",
                                    ...
                                    Epithelial_Endothelial = c("^0$" = "EC_Blood",
                                                                "^1$" = "Stromal_cells",
                                                                "^2$" = "EC_Blood")),
        mm_mets_normal_cells = list(Mesenchymal = c("^0$" = "Alveolar_fibroblasts",
                                                    "^1$" = "Pericytes",
                                                    "^2$" = "Alveolar_fibroblasts",
                                                    "^3$" = "Alveolar_fibroblasts",
                                                    "^4$" = "Adventital_fibroblasts",
                                                    "^5$" = "Smooth_muscle",
                                                    "^6$" = "Smooth_muscle",
                                                    "^7$" = "Alveolar_fibroblasts",
                                                    "^8$" = "Alveolar_fibroblasts"),
                                    Immune_Lymphoid = c("^0$" = "Memory_B",
                                                        ...
                                                        "^12$" = "Lymphocytes",
                                                        "^13$" = "DC"),
                                    Immune_Myeloid = c("^0$" = "Alv_Macrophages",
                                                        "^1$" = "TAMs",
                                                        "^2$" = "Scar_TAMs",
                                                        "^3$" = "Inflam_TAMs",
                                                        "^4$" = "DC",
                                    ...
                                    Epithelial_Endothelial = c("^0$" = "EC_Blood",
                                                                ...
                                                                "^18$" = "EC_Blood",
                                                                "^19$" = "EC_Lymphatic")),
        dogs_prim_normal_cells = list(Immune_Lymphoid = c("^0$" = "CD8_T",
                                                "^1$" = "CD4_T",
                                                "^2$" = "Regulatory_T",
                                                "^3$" = "NK_cells",
                                                "^4$" = "CD4_T",
...
for (item in seq_len(nrow(object_list))) {
    ...
    for (cell_type in unique(object$SingleR_Ann1)) {
        ...
        if (group == "dogs_mets_normal_cells" | group == "dogs_prim_normal_cells") {
            s_obj1 <- s_obj
            cell_ids <-
                s_obj1@meta.data %>%
                dplyr::select(Ann_Level3, seurat_clusters)
            ...
            s_obj <- AddMetaData(s_obj, cell_ids)
        }
