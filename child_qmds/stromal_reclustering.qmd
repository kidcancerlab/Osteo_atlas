    ...
    list(patient_prim_normal_cells = list(Mesenchymal = c("^0$" = "mCAFs",
        ...
        dogs_prim_normal_cells = list(Mesenchymal = c("^0$" = "mCAFs",
                                ...
                                Epithelial_Endothelial = c("^0$" = "Endothelial_Vein",
                                                            ...
                                                            "^6$" = "Endothelial_Vein",
                                                            "^7$" = "Endothelial_Vein")),
        dogs_mets_normal_cells = list(Mesenchymal = c("^0$" = "Smooth_muscle",
                                                    "^1$" ="apCAFs",
                                                    "^2$"= "Alv_CAFs",
                                                    "^3$" = "apCAFs",
                                                    "^4$" = "Adv_CAFs",
...
```{r markers_for_Ann_Level3_compartments}
...
markers <-
    list(Endothelial_Artery = c("NOTCH4", "DLL4", "EFNB2", "FLT1"),
         Endothelial_Vein = c("VWF", "TGFBR3", "PLXDC2"),
         Endothelial_Lymphatic = c("CD36", "PROX1", "FLT4", "SH3PXD2B"),
         Endothelial_Capillary = c("PECAM1", "VWF", "FLT1"),
         AT2 = c("SFTPA1", "SFTPC", "ABCA3"),
         AT1 = c("SFTPA1", "SFTPC", "ABCA3"),
         Ciliated_cells = c("FOXJ1", "RFX3", "RFX2"),
         Tuft_cells = c("TRPM5", "DCLK1", "CHGA"))
