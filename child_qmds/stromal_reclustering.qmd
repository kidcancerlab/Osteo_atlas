...
#dogs 
dogs_mesenchymal_marker_top6_list <- 
    list(Adv_CAFs = list("CADM2", "DCN", "DPT", "SERPINF1"),
        apCAFs = list("CD74", "HLA-DRB1", "DLA-DQB1", "PTPRC"),
        myCAFs = list("ASPN", "DCN", "FBLN1", "SFRP2"),
        pCAFs = list("CENPA", "UBE2C", "CDC20", "CENPF"),
        Pericytes = list("RGS5", "MCAM", "KCNJ8", "GUCY1B1"),
        Progenitor = list("PRRX1", "LEPR", "IGF2", "PTN"),
        Smooth_muscle = list("CNN1", "ACTN2", "MYOCD", "FLNC"))
dog_lymphoid_markers <- 
...
dog_endo_epi <- 
    list(AT1 = list("AGER", "HOPX", "RTKN2", "CLIC5"),
...
dog_Immune_Myeloid <-
    list(DC1 = list("CLNK", "XCR1", "CD226", "TOX"),
        DC2 = list("FCER1A", "CD1B", "MS4A2", "SATB1"),
        Fibrogenic_TAMs = list("MMP16", "CDH11", "COL1A1", "COL1A2"),
        IFN_TAMs = list("IFIT1", "IFIT2", "IFIT3", "IFGGC1"),
        Inflam_TAMs = list("CCL3", "IL1B", "IL37", "IL1A"),
        Migratory_DC = list("CCR7", "CD83", "CD40", "ENPP3"),
        Neutrophils = list("S100A9", "CSF3R", "SELL", "SRGN"),
        Osteoclast_TAMs = list("MMP9", "NFATC1", "ACP5", "ATP6V0D2"),
        pDC = list("BCL11A", "TCF4", "FCRLA", "SPATS2L"),
        Prolif_TAMs = list("CCNA2", "UBE2C", "CENPF", "AURKB"),
        Scar_TAMs = list("TREM2", "GPNMB.1", "CD36", "MSR1"))
...
# HUman
patient_prim_mets_Immune_Myeloid <-
    list(Alv_TAMs = list("MARCO", "FABP4", "PPARG", "OLR1"),
        DC1 = list("IDO1", "CLNK", "CLIC2", "GPR157"),
        DC2 = list("FCER1A", "CLEC10A", "GPAT3", "FCGR2B"),
        Fibrogenic_TAMs = list("COL1A2", "COL3A1", "COL5A1", "SPARC"),
        IFN_TAMs = list("IFIT1", "IFIT2", "IFIT3", "IFI44L"),
        ...
        Prolif_TAMs = list("MKI67", "TOP2A", "CENPF", "NUSAP1"),
        Scar_TAMs = list("TREM2", "FABP5", "GPNMB", "MS4A4A"))
celltype_top5_lymphoid <- 
    list(CD4_T = list("ANXA1", "CD4", "IL7R", "RORA"),
        CD8_T = list("CD8A", "CD8B", "GZMH", "GZMK"),
        Memory_B = list("AFF3", "BANK1", "EBF1", "HLA-DQA1"),
        Naive_T = list("BACH2", "LEF1", "TCF7", "TXK"),
        NK_cells = list("GNLY", "KLRD1", "NKG7", "PRF1"),
        Plasma_B = list("DERL3", "IGHG1", "JCHAIN", "MZB1"),
        Prolif_T = list("MKI67", "NUSAP1", "RRM2", "TOP2A"),
        T_Reg = list("CTLA4", "IL2RA", "TNFRSF18", "TNFRSF4"))

celltype_top5_endo_epi <- 
    list(AT1 = list("AGER", "CLIC5", "COL4A3", "RTKN2"),
        AT2 = list("ABCA3", "SFTPB", "SFTPC", "SLC34A2"),
        Capillary_Aerocyte = list("FENDRR", "GRM8", "HPGD", "IL1RL1"),
        Ciliated_cells = list("DCDC1", "DNAH9", "HYDIN", "LRRIQ1"),
        Endothelial_Activated = list("SLIT2", "SLIT3", "TGFBI", "ZEB2"),
        Endothelial_Artery = list("EFNB2", "GJA4", "IGFBP3", "PIK3R3"),
        Endothelial_Capillary = list("ESM1", "PLVAP", "RGCC", "SPARC"),
        Endothelial_Lymphatic = list("FLT4", "PDPN", "PROX1", "TBX1"),
        Endothelial_Prolif = list("ASPM", "MKI67", "NUSAP1", "TOP2A"),
        Endothelial_Vein = list("ACKR1", "MYRIP", "VCAM1", "ZNF385D"))

mesenchymal_marker_list <- 
...
# Mouse
mouse_mesenchymal <-
    list(Adv_CAFs = c("Dcn", "Col14a1", "Pdgfrl", "Igfbp4"),
        Alv_CAFs = c("Pdgfra", "Fgf10", "Npnt", "Tcf21"),
...
mouse_prim_mets_Immune_Myeloid <-
    list(Alv_TAMs = list("Plet1", "Lpl", "Abcg1", "Mgll"),
        Ciliated_cells = list("Foxj1", "Dnah9", "Hydin", "Rp1"),
        DC1 = list("Itgae", "Cd207", "Wdfy4", "Btla"),
        DC2 = list("Mgl2", "H2-DMb2", "Clec10a", "H2-Oa"),
        Fibrogenic_TAMs = c("Col1a2", "Col3a1", "Sparc", "Col5a1"),
        IFN_TAMs = list("Ifit1", "Ifit2", "Ifi44", "Ifit3"),
        Inflam_TAMs = list("Cxcl1", "Fn1", "Ccl24", "Cxcl3"),
        Migratory_DC = list("Ccr7", "Fscn1", "Ccl5", "Cd40"),
        Monocytes = list("Itgal", "Adgre4", "Treml4", "Spn"),
        Neutrophils = list("S100a8", "S100a9", "Trem1", "Clec4d"),
...
xeno_prim_mets_Immune_Myeloid <-
    list(Alv_TAMs = list("Plet1", "Lpl", "Abcg1", "Mgll"),
        ...
        Migratory_DC = list("Ccr7", "Fscn1", "Ccl5", "Cd40"),
        Monocytes = list("Ly6c2", "Ly6c1", "Ccr2", "Plac8"),
        Neutrophils = list("S100a8", "Csf3r", "Trem1", "Clec4d"),
        Osteoclast_TAMs = list("Acp5", "Ctsk", "Nfatc1", "Mmp9"),
        pDC = list("Ccr9", "Spib", "Bcl11a", "Sell", "Tcf4"),
        Prolif_TAMs = list("Mki67", "Top2a", "Cenpp", "Brip1"),
        Scar_TAMs = list("Trem2", "Cd36", "Gpnmb", "Fabp5"))
...
xeno_mesenchymal <-
    list(Adv_CAFs = c("Dcn", "Lum", "Fbln1", "Igfbp6"),
