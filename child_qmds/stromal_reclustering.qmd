...
# Fibroblasts <- list(Normal_Fibroblasts = ,
    ...
    object$Ann_level1 <-
            stringr::str_replace_all(object$new_annot_clust,
                                    c("^Alv_Macrophages$" = "Macrophages",
                                      ...
                                      "^Basophil_Mast1$" = "Basophil_Mast",
                                      "^Basophil_Mast2$" = "Basophil_Mast",
                                      "^Bronchial_Vessel1$" = "Endothelial_cells",
                                      "^Capillary_Intermediate1$" = "Capillary_cells",
                                      "^CD4_plus_MemoryT$" = "T_cells",
                                      "^CD4T_cells$" = "T_cells",
                                      "^CD4T_Naive$" = "T_cells",
                                      "^CD8T_cells$" = "T_cells",
                                      "^EREG_plus Dendritic$" = "Dendritic_cells",
                                      "^IGSF21_plus_Dendritic_cells$" = "Dendritic_cells",
