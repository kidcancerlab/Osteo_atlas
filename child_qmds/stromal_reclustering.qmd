...
tumor_int <-
    subset(combined_obj, subset = (Ann_Level3 == "Tumor_Interactive"))
FeaturePlot(tumor_int, features = "nCount_RNA", raster=F, order=T)

#dimplot_better(tumor_int, group_by = "Ann_Level3") + NoLegend()
