...
FeaturePlot(s_obj, 
            features = nichenetr::convert_human_to_mouse_symbols(Immune_Lymphoid$Prolif_T))
...
celltype_list <-
    list(patient_prim_normal_cells = list(Mesenchymal = c("^0$" = "CAF",
                                         ...
                                         Immune_Lymphoid = c("^0$" = "CD8_T",
                                                            ...
                                                            "^9$" = "NK_cells",
                                                            "^10$" = "CD8_T",
                                                            "^11$" = "Maps_everywhere_maybe_DC",
                                                            "^12$" = "Maps_everywhere_maybe_TAMs"),
        ...
        mm_mets_normal_cells = list(Mesenchymal = c("^0$" = "Alveolar_fibroblasts",
                                    ...
                                    Immune_Lymphoid = c("^0$" = "Memory_B",
                                                        ...
                                                        "^12$" = "Lymphocytes",
                                                        "^13$" = "DC"),
                                    Immune_Myeloid = c("^0$" = "Alveolar_Mac",
                                                        "^1$" = "TAMs",
                                                        "^2$" = "Scar_TAMs",
                                                        "^3$" = "Inflam_TAMs",
                                                        "^4$" = "DC",
