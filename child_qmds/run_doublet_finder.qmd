...
for (ob_name in ob_names) {
    ...
    tmp_ob <- qs::qread(paste0("/home/gdrobertslab/lab/Analysis/Yogesh/CellTypeAnnRefs/output/seurat_objects/final_tumor_vs_stroma/",
                                       ob_name,
                                       ".qs"))
...
#make list of cancer objects, wanna see if tumor interactive is still messed up
cancer_obs <- obj_list[grep("cancer", names(obj_list), value = TRUE)]
