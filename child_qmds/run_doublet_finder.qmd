...
for (ob in names(cancer_obs)) {
    png(paste0("demuxafy_figs/results_by_annotation_cancer_", ob, ".png"),
        width = 2000,
        height = 800)
    print(
        dimplot_better(
...
for (ob in names(stroma_obs)) {
    png(paste0("demuxafy_figs/results_by_annotation_stroma_", ob, ".png"),
        width = 2000,
        height = 800)
    print(
        dimplot_better(
...
for (ob in names(obj_list)) {
    png(
        paste0("demuxafy_figs/heatmaps/", ob, ".png"),
        width = 480,
        height = 1200
    )
    all_demux[[ob]] %>%
