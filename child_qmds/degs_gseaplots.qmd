...
for (i in seq_len(nrow(object_list))) {
    ...
    if (group == "xeno_prim_human") {
        object$Ann_Level3 <-
            str_replace_all(object$seurat_clusters,      
                          c("^0$" = "Tumor_Progenitor",   #neuronal and bone development axon guidance
                            "^1$" = "",   #not sure
                            "^2$" = "Tumor_Proliferative",
                            "^3$" = "Tumor_HyperMetabolic", 
                            "^4$" = "Tumor_Interactive",
                            "^5$" = "Tumor_Ground",
                            "^6$" = "Tumor_Fibrogenic",     # BNIP3 expressed usually apoptotic
                            "^7$" = "Tumor_Ground",
                            "^8$" = "Tumor_Fibrogenic",
                            "^9$" = "",
        ...
        object$Ann_Level3 <-
            str_replace_all(object$seurat_clusters,
                          c("0" = "Tumor_Fibrogenic",
                            "1" = "Tumor_Progenitor",   #neuronal and bone development axon guidance
