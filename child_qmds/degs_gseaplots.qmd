...
for (i in seq_len(nrow(object_list))) {
    ...
    if (group == "mm_mets_cancer_cells") {
        object$Ann_Level3 <-
            str_replace_all(mm_mets$seurat_clusters,
                          c("^0$" = "Tumor_Proliferative",    #
                            "^1$" = "Tumor_HyperMetabolic",   
                            "^2$" = "Tumor_Progenitor",
    ...
    if (group == "dogs_mets_cancer_cells") {
        object$Ann_Level3 <-
            str_replace_all(doog_mets$seurat_clusters,
...
subset_xeno_prim$newid[subset_xeno_prim$seurat_clusters == "13"] <- "Tumor_HyperMetabolic"
