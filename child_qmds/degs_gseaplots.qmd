...
for (i in seq_len(nrow(object_list))) {
        ...
        object$Ann_Level3 <-
            str_replace_all(object$seurat_clusters,
                          c("0" = "Tumor_Metabolic",    #metabolic phenotype
                            "1" = "Tumor_Osteoblastic",   #collagen and ECM phenotype
                            ...
                            "6" = "Tumor_ImmuneRegulatory", # or low quality
    ...
    if (group == "mm_mets_cancer_cells") {
        object$Ann_Level3 <-
            str_replace_all(object$seurat_clusters,
                          c("0" = "Tumor_Metabolic",    #rho family up
                            "1" = "Tumor_Osteoblastic",
                            "2" = "Tumor_Proliferative",
                            "3" = "Tumor_Proliferative",    #not sure
                            "4" = "Tumor_ImmuneRegulatory",
                            "5" = "Tumor_Ground"))
    }
    if (group == "xeno_prim_human") {
        object$Ann_Level3 <-
            str_replace_all(object$seurat_clusters,       #need to work more on this, its hard
                          c("0" = "Tumor_Metabolic",
                            "1" = "Tumor_Osteoblastic",   #not sure
                            "2" = "Tumor_Ground",
                            "3" = "Tumor_Proliferative",
                            "4" = "Tumor_ImmuneRegulatory",
                            "5" = "Tumor_ImmuneRegulatory"))
    }
    if (group == "xeno_mets_human") {
        object$Ann_Level3 <-
            str_replace_all(object$seurat_clusters,
                          c("0" = "Tumor_Metabolic",
                            "1" = "Tumor_Ground",
                            "2" = "Tumor_Osteoblastic",   #not sure
                            "3" = "Tumor_ImmuneRegulatory",
                            "4" = "Tumor_Proliferative",
