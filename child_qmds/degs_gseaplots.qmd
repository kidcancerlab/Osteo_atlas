    ...
    for (names in unique(object$unique)) {
        ...
        top_markers <- 
            ...
            mutate(cluster = factor(cluster, 
                                levels = c("Fibrogenic", "Interactive", "Progenitor",
                                           "Proliferative", "Stressed", "Synthetic"))) %>%
            arrange(cluster)
        ...
        dotplot_degs <-
            DotPlot(object = object_subset,
                features = genes,
                group.by = "Ann_Level3") +
                scale_y_discrete(limits = c("Fibrogenic", "Interactive", "Progenitor",
                                            "Proliferative", "Stressed", "Synthetic")) +
                RotatedAxis()
        # save the dotplot
...
patient <-
    list(Synthetic = c("RPS28", "RPL36", "RPS13", "RPS27"),
        Fibrogenic = c("COL3A1", "PDGFRB", "COL6A3", "POSTN"),
        Progenitor = c("CD36", "ROBO2", "SATB2", "ANO5"),
        Proliferative = c("TOP2A", "ASPM", "CENPF", "MKI67"),
        Interactive = c("CSF1R", "PTPRC", "PTPRJ"),
        Stressed = c("EGLN3", "VEGFA", "BNIP3", "HILPDA")) %>%
    unlist() %>%
    as.character() %>%
    unique()

mouse <-
    list(Synthetic = c("Rps2", "Rpl10", "Rpl26", "Rpl21"),
        Fibrogenic = c("Col3a1","Pdgfrb", "Bicc1", "Antxr1", "Pdgfrl", "Fap"),
        Progenitor = c("Pdgfc", "Zfp462", "Ahr", "Ptbp2"),
        Proliferative = c("Ccna2", "Cenpf", "Ube2c", "Cenpe"),
        Interactive = c("Alcam", "Ptprc", "Ptprj"),
        Stressed = c("Ifi202b", "Apol9a", "Apol9b", "Eno3", "Ccl9")) %>%
unlist() %>%
as.character() %>%
unique()
...
xenograft <-
    list(Synthetic = c("RPS28", "RPL36", "RPS13", "RPS15", "RPL35", "RPL11", "RPS2"),
        Fibrogenic = c("COL3A1", "COL6A1", "POSTN", "PRRX1", "HMCN1", "COL6A3"),
        Progenitor = c("PTPRZ1", "ROBO2", "CD36", "PDGFD"),
        Proliferative = c("TOP2A", "ASPM", "CENPF", "MKI67"),
        Interactive = c("PTPRJ", "FILIP1L", "ECM2"),
        Stressed = c("NDRG1", "BNIP3", "VEGFA", "DDIT4", "EGLN3")) %>%
    unlist() %>%
    as.character() %>%
    unique()
...
dog <-
    list(Synthetic = c("RPS28", "RPL36", "RPS13", "RPS15", "RPL35", "RPL11", "RPS2"),
        Fibrogenic = c("COL3A1", "COL6A1", "POSTN", "PRRX1", "HMCN1", "COL6A3", "PDGFRB", "COL24A1", "COL11A2"),
        Progenitor = c("PTPRZ1", "ROBO2", "CD36", "PDGFD"),
        Proliferative = c("CENPF", "ASPM", "TK1", "ANLN", "UBE2C"),
        Interactive = c("PTPRC", "CSF1R", "ECM2", "CD44"),
        Stressed = c("PLXDC2", "IGFBP7", "ZFPM2", "CAMK1D", "MAP3K5")) %>%
    unlist() %>%
    as.character() %>%
    unique()
