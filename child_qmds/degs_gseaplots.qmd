...
hypoxia_markers <- c("HIF1A", "EPAS1", "CA9", "SLC2A1", "VEGFA", 
                     "BNIP3", "LDHA", "ENO1", "PFKP", "PDK1")
emt_markers <- c("SNAI1", "SNAI2", "TWIST1", "ZEB1", "ZEB2", 
                 "CDH2", "CDH1")
FeaturePlot(object,
            features = hypoxia_markers,
            ncol = 4)



seurat_obj <- AddModuleScore(object, features = list(genes7), name = "C1_prim_on_mets")

FeaturePlot(seurat_obj,
            features = "C1_prim_on_mets1",
            ncol = 2)
...
tumor <-
    big_object %>%
    subset(seurat_clusters %in% list)
        ...
        object$Ann_Level3 <-
            str_replace_all(object$seurat_clusters,
                          c("0" = "Tumor_Metabolic",    #metabolic phenotype
                            ...
                            "5" = "CAF",  #Immune regulatory interraction, IL10
                            "6" = "Tumor_Interractive", # or low quality
                            "7" = "Tumor_Metabolic",
                            "8" = "Osteoblasts",
                            "9" = "Tumor_Ground",
                            "10" = "Tumor_Interractive"))
    }
