...
#dimplot_better(subset_xeno_prim, group_by = "seurat_clusters")
cluster_annotations <-
...
subset_xeno_prim$newid[subset_xeno_prim$seurat_clusters == "12"] <- "Tumor_Proliferative"
subset_xeno_prim$newid[subset_xeno_prim$seurat_clusters == "23"] <- "Tumor_Proliferative"
subset_xeno_prim$newid[subset_xeno_prim$seurat_clusters == "13"] <- "Tumor_Synthetic"
...
# FeaturePlot(subset_xeno_mets, features = "COL3A1")
...
hyperm <- c("BGLAP", "RPL14", "ATP5PF", "RPL29.1")

metabolic <- c("UQCRB", "LDHB", "MDH2", "ATP5MC3", "ATP5MC1", "TIMM13", "COX6C", "PHB2", "ATP5ME", "ATP5MF", "COX7C", "MRPS12", "UQCRH", "NDUFAB1", "ATP5PF", "TOMM22", "ATP5MC2", "HSD17B10", "SLC25A4", "ATP5PO")

dogs_metas <- c("UQCRQ", "ATP5PO", "COX7A2L", "NDUFB6", "NDUFB3", "HSD17B10", "NDUFA8", "PDHB", "ATP5MF", "ATP5MC3", "COX5B", "TIMM9", "CYCS", "NDUFB4", "MRPL11", "ATP6V1D")
mice_meta <- c(
    "Uqcrh", "Atp5j", "Cox8a", "Atp5e", "Timm13", "Cox7b", "Atp5h", 
    "Uqcrq", "Gpi1", "Cox7c", "Ndufab1", "Atp5g2", "Ndufa7", "Atp5g1", 
    "Slc25a4", "Cox6c", "Ndufa2", "Cox6b1", "Cox7a2l"
)

DimPlot(obj_list$dogs_mets_cancer_cells, cells.highlight = cells)

dimplot_better(obj_list$mm_prim_cancer_cells, group_by = "Ann_Level3") +
    NoLegend()

DotPlot(obj_list$dogs_prim_cancer_cells,
        features = mice_meta %>%
...
DotPlot(obj_list$dogs_mets_cancer_cells,
        features = dogs_metas,
        group.by = "Ann_Level3")
...
hyperm <-
   Reduce(intersect, list(
                           HyperMetabolic$patient_prim_cancer_cells,
                           HyperMetabolic$patient_mets_cancer_cells,
                        #    HyperMetabolic$mm_prim_cancer_cells,
                        #    HyperMetabolic$mm_mets_cancer_cells,
                        #    HyperMetabolic$xeno_prim_human,
                        #    HyperMetabolic$xeno_mets_human,
                           HyperMetabolic$dogs_prim_cancer_cells,
                           HyperMetabolic$dogs_mets_cancer_cells
                           ))
