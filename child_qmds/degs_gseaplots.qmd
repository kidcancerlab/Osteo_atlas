...
5. Tumor_Secretory: pathways up: Kegg_protein_processing_in_endoplasmic_reticulum, Kegg_endocytosis, Kegg_phagosome, Kegg_Lysosome, Kegg_autophagy, Kegg_mTOR_signalling_pathway, Kegg_AMPK_signalling_pathway
    ...
    if (group == "mm_prim_cancer_cells") {
        object$Ann_Level3 <-
            str_replace_all(object$seurat_clusters,
                          c("0" = "Tumor_Cycling",
                            "1" = "Tumor_Metabolic",
                            "2" = "Tumor_Interractive",
                            "3" = "Tumor_Secretory",   #invasive or ECM degradation and hedgehog signaling
