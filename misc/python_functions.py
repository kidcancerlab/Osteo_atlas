...
def save_plots(ob, method)
    ...
    scv.pl.velocity_embedding_stream(merged_ad,
                                     ...
                                     figsize = (7, 7),
                                     legend_loc = "none")
    pyplot.savefig("output/figures/rna_velocity/" + method + "/" + ob + "_umap_clusters.svg")
    ...
    scv.pl.velocity_embedding_stream(merged_ad,
                                     ...
                                     figsize = (7, 7),
                                     legend_loc = "none")
    pyplot.savefig("output/figures/rna_velocity/" + method + "/" + ob + "_fdl_clusters.svg")
    #Now plot cell types
    scv.pl.velocity_embedding_stream(merged_ad,
                                     basis = "umap",
                                     color = "Ann_Level3",
                                     ...
                                     figsize = (7, 7),
                                     legend_loc = "none")
    pyplot.savefig("output/figures/rna_velocity/" + method + "/" + ob + "_umap_annotations.svg")
    #cell types in fdl
    scv.pl.velocity_embedding_stream(merged_ad,
                                     basis = "fdl",
                                     color = "Ann_Level3",
                                     ...
                                     figsize = (7, 7),
                                     legend_loc = "none")
    pyplot.savefig("output/figures/rna_velocity/" + method + "/" + ob + "_fdl_annotations.svg")
