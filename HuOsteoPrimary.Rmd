...
for(i in levels(Idents(tumor))) {
  ...
  e <- enrichr(degs, dbs)
  enriched[[paste("Cluster", i, sep = "_")]] <- as_tibble(e$GO_Biological_Process_2021)
  print(paste("Cluster", i, "top pathways"))
  print(as_tibble(e$GO_Biological_Process_2021), n = 20)
}
```